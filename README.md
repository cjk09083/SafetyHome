...
## 담당 
- Android(JAVA) 프론트/백엔드 개발 (디자인 제외 1인개발)
...
## 주요 문제점 및 해결방법
- 무료 웹서버 사용시 서비스 품질 불안정 </br>
=> Kakao사의 RemoteMonster 서비스를 적용하여 서비스 품질 안정화

- 영상통화 녹화+녹음시 쌍방의 녹음 데이터를 합칠때 싱크 딜레이가 발생 </br>
 => 녹화+녹음 시작될때의 시간과 종료시의 시간을 기록해 이후 자동으로 싱크를 맞도록 음성을 편집해 Merge되도록 기능 추가
